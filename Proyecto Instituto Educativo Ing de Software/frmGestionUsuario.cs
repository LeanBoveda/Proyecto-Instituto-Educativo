...
{
    public partial class frmGestionUsuario : Form, IObservadorIdioma
    {
        ...
        private void btnAgregarUsuario_Click_1(object sender, EventArgs e)
        {
            ...
            cmbRoles.SelectedItem == null)
                ...
                _274LJBBLL_Auditoria _274LJBBLL_Auditoria = new _274LJBBLL_Auditoria();

                auditoria.RegistrarEvento("Admin", "Gestión de Usuarios", $"Se creó el usuario {nuevo.NombreUsuario}", "Media");
